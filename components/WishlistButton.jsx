...
export default function WishlistButton({ jewelleryId, initialIsWishlisted = false, onToggle }) {
    ...
    if (!mounted) return (
        <button className="p-2 rounded-full text-gray-400 bg-gray-100">
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm relative z-[10000] overflow-hidden transform transition-all scale-100 opacity-100">
                        ...
                        <div className="text-center mt-2">
                            ...
                            <div className="space-y-3">
                                <Link
                                    href="/login"
                                    className="block w-full py-3 px-4 bg-yellow-500 hover:bg-yellow-600 text-black font-bold rounded-xl transition-all shadow-lg hover:shadow-xl"
                                >
                                    Login Now
                                </Link>
                                <button
